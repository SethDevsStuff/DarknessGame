...
var hassanLethiaPart1 = [
    ...
    speak(false, 'Lethia', ['Most recently a priest at Thalassa Gardens', 'was killed. I doubt he was innocent.', 'Rumors are he has done-- things', 'to vulnerable children'], () => {goal1.complete();}),
];
...
var goal7 = new Objective(['Make a deal with Ephyra']);
var goal8 = new Objective(['Meet at the docks', 'with the Order of the Last Light']);
...
var goal12 = new Objective(['Find Jude a healer(explore!)']);
...
var agoraTrigC2= comp(220, 00, {width:96, height:32});
...
var tempTrig1 = new Trigger(tempTrigC1, () => {
    if(currentObjective == 2) return false;
    inMenu = true;
    changeScene(backgrounds.agora, agora);
    player.y = 46;
    player.x = 260;
